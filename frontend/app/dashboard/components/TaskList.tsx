  ...
  return (
    <div className="p-6 rounded-3xl bg-slate-800/40 backdrop-blur-sm border border-slate-700/50">
      <div className="flex items-center justify-between mb-5">
        <div>
          <h3 className="text-lg font-bold mb-1">Today's Tasks</h3>
      ...
      <div className="mb-5 h-2 bg-slate-700/50 rounded-full overflow-hidden">
        <div
      ...
      <div className="space-y-2 mb-5">
        {tasks.map(task => (
          <div
            key={task.id}
            className="group flex items-start gap-3 p-4 rounded-xl hover:bg-slate-700/50 transition-all"
          >
            <button
            ...
            <div className="flex-1 min-w-0">
              ...
              <span className="text-xs text-slate-400 ml-4">{task.estimate}</span>
            </div>
          </div>
        ))}
      </div>

      <button className="w-full py-3 rounded-xl border-2 border-dashed border-slate-700 hover:border-purple-500 hover:bg-purple-500/5 transition-all flex items-center justify-center gap-2 text-sm text-slate-400 hover:text-purple-400 font-medium">
