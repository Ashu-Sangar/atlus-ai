        ...
        >
          ...
          <div className="relative group">
            ...
            <div className="relative bg-slate-900/50 backdrop-blur-2xl rounded-3xl border border-slate-800/50 shadow-2xl p-8 md:p-10">
              ...
              <div className="space-y-5">
                ...
                >
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-purple-500 to-cyan-500 hover:from-purple-600 hover:to-cyan-600 transition-all border-0 text-white py-6 text-base font-semibold rounded-xl shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 hover:scale-[1.02] transform flex items-center justify-center gap-2"
                  >
                    Sign In
                    <ArrowRight size={20} />
                  </button>
              ...
              >
                <button className="flex items-center justify-center gap-3 px-4 py-3.5 bg-slate-800/50 border border-slate-700/50 hover:bg-slate-800 hover:border-slate-600 rounded-xl transition-all group">
